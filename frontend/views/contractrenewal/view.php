...
<div class="row">
    <div class="col-md-4">
        ...
        <?= ($model->Approval_Status == 'New') ? Html::a('<i class="fas fa-times"></i> Dont Renew', ['cancel-renewal'], [
            'class' => 'btn btn-app submitforapproval',
            'data' => [
        ...
        <?= ($model->Approval_Status == 'Pending_Approval' && !Yii::$app->request->get('Approval')) ? Html::a('<i class="fas fa-times"></i> Cancel Approval Req.', ['cancel-request'], [
            'class' => 'btn btn-app submitforapproval',
            'data' => [
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <?= ($model->Approval_Status == 'New') ? Html::a('<i class="fa fa-plus-square"></i> Add Line', ['contractrenewalline/create', 'No' => $model->No, 'Employee_No' => $model->Employee_No], [
