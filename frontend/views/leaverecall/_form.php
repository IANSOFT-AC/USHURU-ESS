                ...
                <div class="row">
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            '</p>' ?>
                            <?= '<p><span>Program Code</span> ' . Html::a($model->Global_Dimension_1_Code, '#');
                            '</p>' ?>
                            ...
                            <?= '<p><span>Program Code</span> ' . Html::a($model->Leave_Code, '#');
                            '</p>' ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <?= '<p><span>Program Code</span> ' . Html::a($model->Reliever, '#');
                            '</p>' ?>
