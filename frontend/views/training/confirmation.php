...
$this->params['breadcrumbs'][] = ['label' => 'Trainings Awaiting Confirmation List', 'url' => ['index']];
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Training Awaiting Confirmation List</h3>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            //serverSide: true,  
            ajax: url+'training/list-confirmation',
            paging: true,
            columns: [
