...
$this->params['breadcrumbs'][] = ['label' => 'Trainings Awaiting Availability Confirmation List', 'url' => ['index']];
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Training Awaiting Availability Confirmation List</h3>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            //serverSide: true,  
            ajax: url+'training/list-availability',
            paging: true,
            columns: [
