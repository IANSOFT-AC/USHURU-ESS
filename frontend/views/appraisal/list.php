...
$this->title = 'HRMIS - Appraisal List';
...
<input type="hidden" name="Review_Period" value="<?= $Review_Period ?>">
...
$script = <<<JS
    ...
    $(function(){
        ...
        var Review_Period = $('input[name=Review_Period]').val();
        var Status = $('input[name=Status]').val();
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+`appraisal/list?Review_Period=${Review_Period}&Status=${Status}`,
            paging: true,
            columns: [
