...
<div class="row actions">
    <div class="col-md-4">
        ...
        <?= ($model->Status == 'Inductee') ? Html::a('<i class="fas fa-paper-plane"></i> Send Approval Req', ['send-for-approval'], [
    ...
    <?= ($model->HRO_Emp_No !== Yii::$app->user->identity->{'Employee No_'}) ? Html::a('<i class="fas fa-times"></i> Close Case', ['close-case'], [
