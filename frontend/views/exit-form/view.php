...
<div class="row">
    <div class="col-md-12">
        ...
        <?php if ($model->ClearingEmployee->Employee_No == Yii::$app->user->identity->{'Employee No_'}) { ?>
            ...
            <?= ($model->sequence && $model->sequence == 'Library') ? Html::a('<i class="fas fa-paper-plane"></i> Send to Library', ['clear'], [
                'class' =>  $model->CheckStatus('Library') . ' btn btn-app submitforapproval',
                'data' => [
            ...
            <?= ($model->sequence && $model->sequence == 'Lab') ? Html::a('<i class="fas fa-paper-plane"></i> Send to Lab', ['clear'], [
                'class' => $model->CheckStatus('Lab') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'ICT') ? Html::a('<i class="fas fa-paper-plane"></i> Send to ICT', ['clear'], [
                'class' => $model->CheckStatus('ICT') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'Store') ? Html::a('<i class="fas fa-paper-plane"></i> Send to Store', ['clear'], [
                'class' => $model->CheckStatus('Store') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'Archives') ? Html::a('<i class="fas fa-paper-plane"></i> Send to Archives', ['clear'], [
                'class' => $model->CheckStatus('Archives') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'Assets') ? Html::a('<i class="fas fa-paper-plane"></i> Send to Safety', ['clear'], [
                'class' => $model->CheckStatus('Assets') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'Security') ? Html::a('<i class="fas fa-paper-plane"></i> Send to Security', ['clear'], [
                'class' => $model->CheckStatus('Security') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'Payroll') ? Html::a('<i class="fas fa-paper-plane"></i> Send to Payroll', ['clear'], [
                'class' => $model->CheckStatus('Payroll') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'Personal Account') ? Html::a('<i class="fas fa-paper-plane"></i>  Personal A/C ', ['clear'], [
                'class' => $model->CheckStatus('Personal_Account') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'Training') ? Html::a('<i class="fas fa-paper-plane"></i>  Training ', ['clear'], [
                'class' => $model->CheckStatus('Training') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'Human Resources') ? Html::a('<i class="fas fa-paper-plane"></i>  Human_Resources ', ['clear'], [
                'class' => $model->CheckStatus('Human_Resources') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'Executive Director') ? Html::a('<i class="fas fa-paper-plane"></i>  Executive Director ', ['clear'], [
                'class' => $model->CheckStatus('Executive_Director') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
            ...
            <?= ($model->sequence && $model->sequence == 'HOD') ? Html::a('<i class="fas fa-paper-plane"></i>  HOD ', ['clear'], [
                'class' => $model->CheckStatus('HOD') . ' btn btn-app submitforapproval',
                'data' => [
                    'confirm' => 'Are you sure you want to send this document ?',
                    'params' => [
                        'exitNo' => $model->Exit_No,
        ...
        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'}) ? Html::a('<i class="fas fa-check"></i> Clear', ['clear-section'], [
            'class' => 'btn btn-app clear-section',
            'data' => [
        ...
        <?php if ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'}) { ?>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="YesOption" value="Yes" />
                <label class="form-check-label" for="inlineRadio1">Yes</label>
            </div>

            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="NoOption" value="No" />
        ...
        <?php if (
            ...
            <div class="card" id="Library">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'Library') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'library/create',
        ...
        if (
            ...
            <div class="card" id="Lab">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'Lab') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'lab/create',
                            'Form_No' => $model->Form_No,
                            'Exit_no' => $model->Exit_No,
                            'Employee_no' => $model->Employee_No
            ...
            <div class="card" id="ICT_Clearance_Lines">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'ICT') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'ict/create',
                            'Form_No' => $model->Form_No,
                            'Exit_no' => $model->Exit_No,
                            'Employee_no' => $model->Employee_No
            ...
            <div class="card" id="Store_CLearance_Form">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'Store') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'store/create',
                            'Form_No' => $model->Form_No,
                            'Exit_no' => $model->Exit_No,
                            'Employee_no' => $model->Employee_No
            ...
            <div class="card" id="Assigned_Assets_Clearance">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'Assets') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'asset/create',
            ...
            <div class="card" id="Security">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'Security') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'security/create',
                            'Form_No' => $model->Form_No,
                            'Exit_no' => $model->Exit_No,
                            'Employee_no' => $model->Employee_No
        ...
        <?php if (
            ...
            <div class="card" id="Training">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'Training') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'training/create',
                            'Form_No' => $model->Form_No,
                            'Exit_no' => $model->Exit_No,
                            'Employee_no' => $model->Employee_No
        ...
        <?php if (
            ...
            <div class="card" id="Payroll">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'Payroll') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'payroll/create',
                            'Form_No' => $model->Form_No,
                            'Exit_no' => $model->Exit_No,
                            'Employee_no' => $model->Employee_No
        ...
        <?php if (
            ...
            <div class="card" id="Personal">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'Personal_Account') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'personal/create',
                            'Form_No' => $model->Form_No,
                            'Exit_no' => $model->Exit_No,
                            'Employee_no' => $model->Employee_No
        ...
        <?php if (
            ...
            <div class="card" id="Personal">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <?= ($model->ClearingEmployee->Clearing_Employee == Yii::$app->user->identity->{'Employee No_'} && $model->Action_ID == 'Archives') ? Html::a('<i class="fas fa-plus-square mr-2"></i>Add', [
                            'archive/create',
                            'Form_No' => $model->Form_No,
                            'Exit_no' => $model->Exit_No,
                            'Employee_no' => $model->Employee_No
