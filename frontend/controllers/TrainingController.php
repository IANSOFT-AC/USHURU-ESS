...
class TrainingController extends Controller
{
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout', 'signup', 'index', 'create', 'update', 'delete', 'training-confirmation', 'training-hr', 'training-attended'],
                'rules' => [
                    [
                        'actions' => ['signup'],
                        'allow' => true,
                    ...
                    [
                        'actions' => ['logout', 'index', 'list', 'create', 'update', 'delete', 'training-confirmation', 'training-hr', 'training-attended'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
            ...
            'contentNegotiator' => [
                ...
                'only' => ['list-availability', 'list-confirmation', 'list-hr', 'list-attended'],
                'formatParam' => '_format',
                'formats' => [
    ...
    public function actionTrainingConfirmation()
    {
        return $this->render('confirmation');
    }

    public function actionTrainingHr()
    {
        return $this->render('hr');
    }

    public function actionTrainingAttended()
    {
    ...
    public function actionListAvailability()
    {
        ...
        foreach ($records as $quali) {
            ...
            $actionConfirmAvailability =  Html::a('<i class="fa fa-forward"></i>', ['confirm-availability'], [
                ...
                'data' => [
                    ...
                    'confirm' => 'Are you sure you want to confirm availability, if yes this will also create a staff claim for you.',
                    'method' => 'post'
                ]
            ]);
            $cancelApproval = (!empty($quali->Status) && $quali->Status == 'Pending_Approval') ? Html::a('<i class="fa fa-times"></i>', ['cancelApprovalRequest', 'No' => $quali->Application_No], ['class' => 'btn btn-outline-warning btn-xs mx-2', 'title' => 'Cancel Approval Request']) : '';
            ...
            $result['data'][] = [
                ...
                'Action' => $viewLink . $actionConfirmAvailability
            ];
        }
        return $result;
    }
    ...
    public function actionListAttended()
    {
        $service = Yii::$app->params['ServiceName']['TrainingApplicationList'];
