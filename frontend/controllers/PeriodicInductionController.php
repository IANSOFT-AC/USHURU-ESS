...
class PeriodicInductionController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $model = new Induction();
        $service = Yii::$app->params['ServiceName']['PeriodicInductionCard'];
    ...
    {
        $service = Yii::$app->params['ServiceName']['PeriodicInductionList'];
