...
class KpiRatingController extends Controller
{
    ...
    public function actionIndex($Kpi_Line_No,$Kra_Line_No,$Appraisal_No,$Employee_No)
    {

        $service = Yii::$app->params['ServiceName']['AppraisalKPIRating'];
        $filter = [
            'Kpi_Line_No' => $Kpi_Line_No,
